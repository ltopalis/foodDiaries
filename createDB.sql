...
INSERT INTO `person` (`email`, `name`, `lastname`, `password`, `last_login`, `signup_date`, `role`, `phone_number`) VALUES
('dimitris@gmail.com', 'Δημήτρης', 'Δημητρίου', 'dimitris', '2024-04-24 20:48:17', '2024-05-24 17:48:17', 'DOCTOR', '6978541230'),
('george@gmail.com', 'Γεώργιος', 'Γεωργίου', 'george', '2024-05-24 20:48:17', '2024-05-24 17:48:17', 'TRAINER', '6952130479');
...
CREATE TABLE `product` (
  ...
  `category` enum('GYM','FOODS') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
